...
try {
 ...
 <form className='w-[90%] h-[600px] max-w-[500px] bg-[#0000008a] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
